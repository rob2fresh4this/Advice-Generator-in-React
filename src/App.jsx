  ...
  return (
    ...
    >
      <div
        ...
        style={{
          maxWidth: "90%", // Mobile: Uses max-width for adaptability
          width: "24rem",  // Desktop: Keeps original design
          borderRadius: "15px",
      ...
      >
        <div className="card-body">
          ...
          <div className="d-flex justify-content-center">
            <div className=""></div>
            <button
              className="btn d-flex justify-content-center align-items-center shadow-lg"
              style={{
